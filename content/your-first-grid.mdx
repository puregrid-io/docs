...
- A unique property value per item. If your rows don't have one then add one at the point of creating the data object, a simple incrementing counter such as `` `id-${ref++}` `` will do as long as it's done once.
